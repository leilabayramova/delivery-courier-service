...
public class GlobalExceptionHandler {
    ...
    public ErrorResponse handleCourierNotFoundException(
    ...
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public ErrorResponse handleNoAvailableCourierException(
    ...
    public ErrorResponse handleInvalidCourierStatusException(
